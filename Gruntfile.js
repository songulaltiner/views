...
module.exports = function(grunt) {
	...
	var generateNamespace = require('./grunt/views-namespace-generator.js');
	...
	grunt.initConfig({
		...
		meta: {
			...
			jsPath: 'js/',
			sassPath: 'sass/',
			examplesPath: 'examples/hello-views/'
		},

		banner: '/*!\n' +
			' * =====================================================\n' +
			' * Views v<%= pkg.version %> - Alpha (<%= pkg.homepage %>)\n' +
			' * =====================================================\n' +
			' */\n',
		...
		sass: {
			...
			dist: {
				files: {
					'<%= meta.distPath %>css/<%= pkg.name %>.css': 'sass/views.scss',
				}
			}
		},
